...
%                      for comparison. For both a comparison function is
%                      also incoporated into the pre-computation step.        
%                      The CBF/CLF is pre-computed  and  stored in .mat file, 
%                      which is the used in CBF_CLF_QP_simulation.m.
%
%   License: see License file in repository.   
%
%   Needed software: - CasADi 3.6  (needed for CaSoS)
%                    - CaSoS 
